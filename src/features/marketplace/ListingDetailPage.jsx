...
// BE returns GRADE_A/B/C/D → display label + CSS class
function mapCondition(condition) {
  switch (condition) {
    case 'GRADE_A': return { label: 'New / Surplus', cls: 'cond-new' }
    case 'GRADE_B': return { label: 'Pre-loved / Good', cls: 'cond-pre' }
    case 'GRADE_C': return { label: 'Fair / Minor Wear', cls: 'cond-pre' }
        ...
        <div className="detail-layout">
          <section className="detail-left">
            ...
            <div style={{ display: 'flex', gap: 8, marginBottom: 16 }}>
              <div className="sk" style={{ width: 80, height: 24, borderRadius: 99 }} />
              <div className="sk" style={{ width: 100, height: 24, borderRadius: 99 }} />
              <div className="sk" style={{ width: 90, height: 24, borderRadius: 99 }} />
            </div>
            {/* Title */}
          ...
          <aside className="detail-right">
            <div className="seller-card">
              <div className="sk" style={{ width: '100%', height: 120, borderRadius: 10 }} />
            </div>
          </aside>
        </div>
      </div>
    ...
    request(`/listings/${id}`)
      ...
      .catch(() => {
        ...
        if (localItem) {
          ...
          setOtherFromSeller(
            LISTINGS.filter(l => l.seller?.id === localItem.seller?.id && l.id !== localItem.id)
            ...
            <div className="detail-specs">
              ...
              <div className="spec">
                ...
                <div className="spec-v">
                  {listing.quantity ?? listing.volume?.value} {listing.unit ?? listing.volume?.unit ?? 'kg'}
                </div>
              </div>
              {listing.address && (
                <div className="spec">
                    ...
                    <Link key={o.id} className="mini-card" to={`/marketplace/${o.id}`}>
                      ...
                      <div className="mini-body">
                        ...
                        <div className="mini-meta">
                          {o.city} • {o.quantity ?? o.volume?.value} {o.unit ?? o.volume?.unit ?? 'kg'}
                        </div>
